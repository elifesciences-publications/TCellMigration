...
def import_data_and_measure( trajectory_file ):
    ...
    corr_times_shallow_dict, speeds_dict = trajectory_analysis_functions_09192019.correlation_times_lengths_by_cell_shallow( trajectory_dict_polar, calculation='times', overlap=True )
    ...
    return master_trajectory_dict, trajectory_dict_polar, trajectory_dict_polar_interp, speeds_dict, corr_times_dict, corr_times_shallow_dict, corr_lengths_dict, step_angle_coupling_dict

def import_data_and_measure_noss( trajectory_file ):
